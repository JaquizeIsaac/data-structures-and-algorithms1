...
const sortNumbers = (arr) => arr.sort((small, large) => small - large);
/* ------------------------------------------------------------------------------------------------
CHALLENGE 4
...
const sortBackwards = (arr) => arr.sort((small, large) => large - small);
/* ------------------------------------------------------------------------------------------------
CHALLENGE 5
...
const sortByPrice = (arr) => arr.sort((small, large) => small.price - large.price);
/* ------------------------------------------------------------------------------------------------
